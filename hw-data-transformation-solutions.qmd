...
1.  Use the `read_csv()` function to import the 'country_level_data_0.csv' file from the md-05/data folder by assigning it to an object name `global_waste_data`
