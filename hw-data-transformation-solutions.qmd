---
title: "Homework Exercise - Data transformation (Solutions)"
format:
  html:
...
We work through this file in two ways:

- **In class (your turn, in break-out rooms):** After each "our turn" live demo, you work on parts of this file together in break-out rooms.
  - **Breakout 1:** Task 1 (Data import) and Task 2 (Data tidying)
  - **Breakout 2:** the remaining parts of Task 3 (Data transformation)
- **At home (homework):** Everything you do not finish in the break-out rooms, plus Task 4 (Data visualisations), Task 5 (Tables), and Task 6 (Complete assignment).

The live demos happen in `live-data-transformation.qmd`, which is for the instructor to write code while you follow along. You write your own code in this file.
...
1.  Load the `dplyr`, `readr`, `ggplot2`, `here`, `gt`, and `knitr` R Packages.
...
3.  Write a meaningful commit message (e.g. "Completed week 5 data transformation homework") in the **Commit message** box
4.  Click **Commit**. Note that every commit needs to have a commit message associated with it.
5.  Click **Push** to send your changes to GitHub.
6.  Go to your md-05-USERNAME GitHub repo (where USERNAME is your GitHub username) and refresh the page. You should see your commit message next to the updated files.

## Open an issue on GitHub

Once you have ensured that the Quarto document renders without errors and you have pushed all your changes to GitHub, it is to complete the assignment by opening an issue on your md-05-USERNAME GitHub repo (where USERNAME is your GitHub username).

1.  Navigate to your md-05-USERNAME GitHub repo (where USERNAME is your GitHub username).
